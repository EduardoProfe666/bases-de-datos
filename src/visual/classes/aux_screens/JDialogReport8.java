...
public class JDialogReport8 extends JDialogGeneral {
	private static final long serialVersionUID = 1L;
	private JRadioButton group;
	private JRadioButton annual;

	public JDialogReport8(ColorScheme e, JFrame padre) {
		super("Reporte de Bajas", e, padre); 
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if(annual.isSelected()) {
						ServicesLocator.getReportServices().loadReport8A();
						dispose();
					}
					else {
						ServicesLocator.getReportServices().loadReport8G();
						dispose();
					}
